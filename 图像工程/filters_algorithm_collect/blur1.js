// http://blog.csdn.net/matrix_space/article/details/40896455 径向模糊
let src = cv.imread('canvasInput');
    ...
    {  
        ...
        {  
            ...
            {  
                let tmR=R-mm>0 ? R-mm : 0.0;  
  
                new_x=tmR*Math.cos(angle)+Center.x;  
                new_y=tmR*Math.sin(angle)+Center.y;  
